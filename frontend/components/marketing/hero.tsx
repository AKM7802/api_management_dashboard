      ...
      <div className="mx-auto grid w-full max-w-6xl items-center gap-12 px-4 py-20 sm:px-6 sm:py-28 lg:grid-cols-2 lg:py-32">
        <div className="flex flex-col items-start gap-6">
          ...
          <p className="max-w-xl text-lg text-muted-foreground text-pretty">
            Stop handing out real API keys. Issue safe proxy tokens, route every
            request through one gateway, and see exactly how each upstream API
            is used — requests, tokens, latency, and cost.
          </p>
